...
// ConfirmDialogDefault 컴포넌트 Props 타입 선언
export interface IConfirmDialogDefaultProps {
	title?: string;
	message: string;
...
// ConfirmDialogDefault 컴포넌트 ($ui.alert() 으로 사용할 UI 컴포넌트)
const ConfirmDialogDefault: IComponent<IConfirmDialogDefaultProps> = ({
	title,
	message,
	type = 'info',
	confirmButtonText,
...
ConfirmDialogDefault.displayName = 'ConfirmDialogDefault';
